...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "dashboard.empty_providers": 'No visible providers. Add entries to <code>providers.yaml</code>.',
        # --- history --------------------------------------------------------
        ...
        "tray.show_inactive": "Show inactive",
        ...
        "tray.remaining": "{label}: {percent}% left",
        "tray.reset_in": " · resets in {when}",
        "tray.reset_now": "now",
        "tray.muted": " (muted)",
        "tray.hidden_inactive": "{count} hidden (inactive)",
    },
    "pt-BR": {
        "html.lang": "pt-BR",
        ...
        "dashboard.empty_providers": 'Nenhum provider visível. Adicione entradas em <code>providers.yaml</code>.',
        ...
        "tray.show_inactive": "Mostrar inativos",
        ...
        "tray.startup_error": "startup: {error}",
        "tray.remaining": "{label}: {percent}% restante",
        "tray.reset_in": " · reset em {when}",
        "tray.reset_now": "agora",
        "tray.muted": " (mudo)",
        "tray.hidden_inactive": "{count} oculto(s) (inativos)",
    },
}
